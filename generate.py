...
def create_default_templates():
    ...
    # Check if templates exist, if so, don't overwrite
    default_file = layouts_dir / 'default.html'
    course_file = layouts_dir / 'course.html'
    
    if default_file.exists() and course_file.exists():
...
<head>
    ...
    <title>{% if page_title %}{{ page_title }} - {% endif %}DataTalks.Club FAQ</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <nav class="course-nav">
            ...
            <a href="{{ course.name }}.html">{{ course.name | title_case }}</a>
            {% endfor %}
        </nav>
        {% endif %}
    ...
    # Course template
    course_template = """{% extends "default.html" %}
...
{% endblock %}"""
    ...
    print("Set up templates in {layouts_dir}".format(layouts_dir=layouts_dir))
